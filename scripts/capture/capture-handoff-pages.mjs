...
import { erpSourceProvenance } from '../handoff/erp-source-provenance.mjs'
...
const units=JSON.parse(await fs.readFile('scripts/handoff/erp-designer-work.json','utf8'))
const hidden=new Set(JSON.parse(await fs.readFile('scripts/handoff/handoff-hidden-captures.json','utf8')).ids)
