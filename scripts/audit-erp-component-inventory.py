...
r=Path(__file__).resolve().parents[1];m=json.loads((r/'public/html/erp/manifest.json').read_text())['pages'];pages=[p for p in m if p['group'] not in ['로그인·가입·무료체험','공통 UI · 사이드바','변경된 화면']]
