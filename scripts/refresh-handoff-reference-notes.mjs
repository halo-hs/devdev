...
const flows=JSON.parse(await fs.readFile('scripts/erp-designer-flows.json','utf8'))
const menus=JSON.parse(await fs.readFile('scripts/erp-designer-menus.json','utf8'))
