...
d=json.loads((r/'scripts/erp-designer-component-boundaries.json').read_text());inventory=json.loads((r/'docs/screens/ui-component-inventory-562.json').read_text());e=html.escape
