...
import MoreHorizontalIcon from "@ecoya/design-system/assets/icons/icon-more.svg"
...
function PaginationEllipsis({
  ...
  return (
    <span
      ...
      className={cn(
        "flex size-[var(--control-size-sm)] items-center justify-center [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
