...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-xs tracking-shortcut text-[var(--surface-muted-foreground)] group-focus/dropdown-menu-item:text-[var(--menu-item-foreground)]",
        className
      )}
      {...props}
    />
